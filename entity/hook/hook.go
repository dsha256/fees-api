...
type BillFunc func(context.Context, *entity.BillMutation) (entity.Value, error)

// Mutate calls f(ctx, m).
func (f BillFunc) Mutate(ctx context.Context, m entity.Mutation) (entity.Value, error) {
	if mv, ok := m.(*entity.BillMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entity.BillMutation", m)
}

// The LineItemFunc type is an adapter to allow the use of ordinary
// function as LineItem mutator.
type LineItemFunc func(context.Context, *entity.LineItemMutation) (entity.Value, error)

// Mutate calls f(ctx, m).
func (f LineItemFunc) Mutate(ctx context.Context, m entity.Mutation) (entity.Value, error) {
	if mv, ok := m.(*entity.LineItemMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entity.LineItemMutation", m)
}
